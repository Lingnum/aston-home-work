...
public class HomePage {
    ...
    private final By blockTitleLocator = By.cssSelector(".pay__wrapper h2");

    // Локаторы для логотипов платежных систем
    private final By logoContainer = By.cssSelector(".pay__partners ul");
    private final By visaLogo = By.cssSelector("img[alt='Visa']");
    private final By mastercardLogo = By.cssSelector("img[alt='MasterCard']");
    private final By belkartLogo = By.cssSelector("img[alt='Белкарт']");
