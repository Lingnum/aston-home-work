...
public class PaymentPage {
    ...
    private final By internetPhonePlaceholder = By.id("internet-phone");

    // Локаторы для формы Рассрочка
    private final By installmentPhonePlaceholder = By.id("score-instalment");

    // Локаторы для формы Задолженность
    private final By debtPhonePlaceholder = By.id("score-arrears");
